...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=lwcontroller.k8s.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("lws"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Lwcontroller().V1alpha1().Lws().Informer()}, nil
